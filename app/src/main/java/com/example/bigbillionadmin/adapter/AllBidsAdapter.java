...
public class AllBidsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AllBidsAdapter(Activity activity, ArrayList<BIDS> bids, ArrayList<BIDS> bids2, ArrayList<String> number, ArrayList<String> andarnum,ArrayList<String> baharnum, ArrayList<HarufBids> andarBids, ArrayList<HarufBids> baharBids) {
